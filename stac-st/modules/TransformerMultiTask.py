"""
    Transformer Multitask model (ASR+ST) in the SpeechBrain style.
...
class TransformerMultiTask(TransformerInterface):
    """This is an implementation of transformer model for MultiTask.
    This model is very similar to TransformerASR.TransformerASR() class
